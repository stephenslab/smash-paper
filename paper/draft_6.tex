...
smoother mean and variance (standard deviation) functions, specifically scenario A from \cite{Menictas2015Variational} (shown in Figure \ref{fig:mfvb_fn}),
...
where $m(\cdot)$ and $s(\cdot)$ denote the mean and standard deviation functions (Figure \ref{fig:mfvb_fn}). We measured performance by the MSE 
