...
# Shift a vector one unit to the right (or left).
# @param x: a vector
...
# Produces two TI tables. One table contains the difference between
# adjacent pairs of data in the same resolution, and the other table
# contains the sum.
# 
