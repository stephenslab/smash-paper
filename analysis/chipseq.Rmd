...
there are too many data points to plot them individually.)
...
intensity estimates align very closely with the peaks found by
MACS. Intriguingly, the SMASH estimates also suggest the presence of
several additional weaker peaks that were not identified by MACS.
