...
Variational Bayes (MFVB) method against SMASH in two scenarios.
...
```{r plot-mean-and-variance, fig.height=4, fig.width=5}
xgrid <- (0:10000)/10000
...
In the first scenario, we simulated unevenly spaced data points, and
assessed accuracy by computing the mean of the squared errors (MSE)
evaluated at 201 equally spaced points.

```{r simulation-1-initialize, eval=FALSE}
...
```{r simulation-1-main-loop, eval=FALSE} 
