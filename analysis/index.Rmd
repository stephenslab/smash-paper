...
+ The `output` directory contains results from the Gaussian and
  Poisson simulations. File `pois_hf.RData` contains results from
  experimenting with different Gaussian denoising techniques for the
  Haar-Fisz algorithm in the Poisson simulations.
