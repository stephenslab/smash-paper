...
1. [Illustration of SMASH applied to the "spikes" data set.](spikesdemo.html)

2. [Comparison of signal denoising methods in Gaussian-distributed data
   sets.](gaussian.mean.est.html)

3. [Application of SMASH to motorcycle acceleration data.](motorcycle.html)

4. [Application of SMASH to ChIP-seq data.](chipseq.html)
