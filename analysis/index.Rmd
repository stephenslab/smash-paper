...
see the `copyright.m` in the WavDen subdirectory. Note that we made
one small improvement to the code in `blockJS.m` to prevent an error
that occurs when running the code in newer versions of MATLAB.
