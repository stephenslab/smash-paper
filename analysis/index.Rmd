...
2. [Mean and variance functions used to simulate Gaussian data for mean-estimation experiments.](gaussian_signals.html).

3. [Estimating the variance function from Gaussian-distributed
