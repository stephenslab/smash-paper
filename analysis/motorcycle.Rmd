...
applied to the Motorcycle Acceleration data. This implements the
...
packages. The MASS package is loaded only for the Motorcycle Acceleration
...
Apply SMASH to the Motorcycle Acceleration data set.
...
Create a plot showing the Motorcycle Acceleration data and the smash
...
Apply TI thresholding to the Motorcycle Acceleration data
-----------------------------------------------------

Apply TI thresholding to the Motorcycle Acceleration data set. In this
...
Apply TI thresholding to the Motorcycle Acceleration data, this time using
