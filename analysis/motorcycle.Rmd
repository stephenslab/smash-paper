...
And in this next plot, we compare the SMASH estimates (orange line)
against the the mean estimates obtained by TI thresholding (dark blue
...
is provided with the SMASH variance estimates, the mean signal is much
more smooth.
