...
homo.data.smash.homo = res[res$.id == "sp.3.v1" &
    res$method == "smash.homo.s8" , ]
homo.data.tithresh = res[res$.id == "sp.3.v1" &
    res$method == "tithresh.homo.s8" , ]
homo.data.ebayes = res[res$.id == "sp.3.v1" &
    res$method == "ebayesthresh" , ]
homo.data.smash.true = res[res$.id == "sp.3.v1" &
    res$method == "smash.true.s8" , ]
homo.data = res[res$.id == "sp.3.v1" &
    (res$method == "smash.s8" |
     res$method == "ebayesthresh" |
     res$method == "tithresh.homo.s8"), ]
...
# errors.)
par(cex.axis = 0.75, cex.lab = 1, cex.sub = 1, mgp = c(3, 1.5, 0))
vioplot.col(homo.data.smash$mise, homo.data.smash.homo$mise,
            homo.data.tithresh$mise, homo.data.ebayes$mise,
