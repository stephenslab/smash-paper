...
Here we create plots and tables to compare SMASH and against other
methods for reconstructing a spatially structured signal from
...
summarize the error (MISE) in the estimates from the 100 data sets in
each setting.

The plots below summarizing the results from the "Bursts" simulations
