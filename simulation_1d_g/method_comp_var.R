...
var.est.ash.haar.cons.v1=matrix(0,100,n)
var.est.ash.haar.cons.v2=matrix(0,100,n)
var.est.ash.haar.cons.v3=matrix(0,100,n)
var.est.ash.haar.cons.v4=matrix(0,100,n)

var.est.ash.haar.sine.v1=matrix(0,100,n)
var.est.ash.haar.sine.v2=matrix(0,100,n)
var.est.ash.haar.sine.v3=matrix(0,100,n)
var.est.ash.haar.sine.v4=matrix(0,100,n)

var.est.ash.haar.bump.v1=matrix(0,100,n)
var.est.ash.haar.bump.v2=matrix(0,100,n)
var.est.ash.haar.bump.v3=matrix(0,100,n)
var.est.ash.haar.bump.v4=matrix(0,100,n)

var.est.ash.haar.blk.v1=matrix(0,100,n)
var.est.ash.haar.blk.v2=matrix(0,100,n)
var.est.ash.haar.blk.v3=matrix(0,100,n)
var.est.ash.haar.blk.v4=matrix(0,100,n)

var.est.ash.haar.dop.v1=matrix(0,100,n)
var.est.ash.haar.dop.v2=matrix(0,100,n)
var.est.ash.haar.dop.v3=matrix(0,100,n)
var.est.ash.haar.dop.v4=matrix(0,100,n)


var.est.ash.haar.j.cons.v1=matrix(0,100,n)
var.est.ash.haar.j.cons.v2=matrix(0,100,n)
var.est.ash.haar.j.cons.v3=matrix(0,100,n)
var.est.ash.haar.j.cons.v4=matrix(0,100,n)

var.est.ash.haar.j.sine.v1=matrix(0,100,n)
var.est.ash.haar.j.sine.v2=matrix(0,100,n)
var.est.ash.haar.j.sine.v3=matrix(0,100,n)
var.est.ash.haar.j.sine.v4=matrix(0,100,n)

var.est.ash.haar.j.bump.v1=matrix(0,100,n)
var.est.ash.haar.j.bump.v2=matrix(0,100,n)
var.est.ash.haar.j.bump.v3=matrix(0,100,n)
var.est.ash.haar.j.bump.v4=matrix(0,100,n)

var.est.ash.haar.j.blk.v1=matrix(0,100,n)
var.est.ash.haar.j.blk.v2=matrix(0,100,n)
var.est.ash.haar.j.blk.v3=matrix(0,100,n)
var.est.ash.haar.j.blk.v4=matrix(0,100,n)

var.est.ash.haar.j.dop.v1=matrix(0,100,n)
var.est.ash.haar.j.dop.v2=matrix(0,100,n)
var.est.ash.haar.j.dop.v3=matrix(0,100,n)
var.est.ash.haar.j.dop.v4=matrix(0,100,n)
...
mse.ash.haar.cons.v1=mean(apply((var.est.ash.haar.cons.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.cons.v2=mean(apply((var.est.ash.haar.cons.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.cons.v3=mean(apply((var.est.ash.haar.cons.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.cons.v4=mean(apply((var.est.ash.haar.cons.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.sine.v1=mean(apply((var.est.ash.haar.sine.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.sine.v2=mean(apply((var.est.ash.haar.sine.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.sine.v3=mean(apply((var.est.ash.haar.sine.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.sine.v4=mean(apply((var.est.ash.haar.sine.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.bump.v1=mean(apply((var.est.ash.haar.bump.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.bump.v2=mean(apply((var.est.ash.haar.bump.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.bump.v3=mean(apply((var.est.ash.haar.bump.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.bump.v4=mean(apply((var.est.ash.haar.bump.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.blk.v1=mean(apply((var.est.ash.haar.blk.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.blk.v2=mean(apply((var.est.ash.haar.blk.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.blk.v3=mean(apply((var.est.ash.haar.blk.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.blk.v4=mean(apply((var.est.ash.haar.blk.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.dop.v1=mean(apply((var.est.ash.haar.dop.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.dop.v2=mean(apply((var.est.ash.haar.dop.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.dop.v3=mean(apply((var.est.ash.haar.dop.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.dop.v4=mean(apply((var.est.ash.haar.dop.v4-rep(1,100)%o%var4)^2,1,mean))


mse.ash.haar.j.cons.v1=mean(apply((var.est.ash.haar.j.cons.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.j.cons.v2=mean(apply((var.est.ash.haar.j.cons.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.j.cons.v3=mean(apply((var.est.ash.haar.j.cons.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.j.cons.v4=mean(apply((var.est.ash.haar.j.cons.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.j.sine.v1=mean(apply((var.est.ash.haar.j.sine.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.j.sine.v2=mean(apply((var.est.ash.haar.j.sine.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.j.sine.v3=mean(apply((var.est.ash.haar.j.sine.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.j.sine.v4=mean(apply((var.est.ash.haar.j.sine.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.j.bump.v1=mean(apply((var.est.ash.haar.j.bump.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.j.bump.v2=mean(apply((var.est.ash.haar.j.bump.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.j.bump.v3=mean(apply((var.est.ash.haar.j.bump.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.j.bump.v4=mean(apply((var.est.ash.haar.j.bump.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.j.blk.v1=mean(apply((var.est.ash.haar.j.blk.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.j.blk.v2=mean(apply((var.est.ash.haar.j.blk.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.j.blk.v3=mean(apply((var.est.ash.haar.j.blk.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.j.blk.v4=mean(apply((var.est.ash.haar.j.blk.v4-rep(1,100)%o%var4)^2,1,mean))

mse.ash.haar.j.dop.v1=mean(apply((var.est.ash.haar.j.dop.v1-rep(1,100)%o%var1)^2,1,mean))
mse.ash.haar.j.dop.v2=mean(apply((var.est.ash.haar.j.dop.v2-rep(1,100)%o%var2)^2,1,mean))
mse.ash.haar.j.dop.v3=mean(apply((var.est.ash.haar.j.dop.v3-rep(1,100)%o%var3)^2,1,mean))
mse.ash.haar.j.dop.v4=mean(apply((var.est.ash.haar.j.dop.v4-rep(1,100)%o%var4)^2,1,mean))
...
mse.cons.v1=c(
mse.ash.haar.cons.v1,
mse.ash.haar.j.cons.v1,
mse.ash.s8.cons.v1,
mse.ash.s8.j.cons.v1
)
...
mse.cons.v2=c(
mse.ash.haar.cons.v2,
mse.ash.haar.j.cons.v2,
mse.ash.s8.cons.v2,
mse.ash.s8.j.cons.v2
)
...
mse.cons.v3=c(
mse.ash.haar.cons.v3,
mse.ash.haar.j.cons.v3,
mse.ash.s8.cons.v3,
mse.ash.s8.j.cons.v3
)
...
mse.cons.v4=c(
mse.ash.haar.cons.v4,
mse.ash.haar.j.cons.v4,
mse.ash.s8.cons.v4,
mse.ash.s8.j.cons.v4
)
...
mse.sine.v1=c(
mse.ash.haar.sine.v1,
mse.ash.haar.j.sine.v1,
mse.ash.s8.sine.v1,
mse.ash.s8.j.sine.v1
)
...
mse.sine.v2=c(
mse.ash.haar.sine.v2,
mse.ash.haar.j.sine.v2,
mse.ash.s8.sine.v2,
mse.ash.s8.j.sine.v2
)
...
mse.sine.v3=c(
mse.ash.haar.sine.v3,
mse.ash.haar.j.sine.v3,
mse.ash.s8.sine.v3,
mse.ash.s8.j.sine.v3
)
...
mse.sine.v4=c(
mse.ash.haar.sine.v4,
mse.ash.haar.j.sine.v4,
mse.ash.s8.sine.v4,
mse.ash.s8.j.sine.v4
)
...
mse.bump.v1=c(
mse.ash.haar.bump.v1,
mse.ash.haar.j.bump.v1,
mse.ash.s8.bump.v1,
mse.ash.s8.j.bump.v1
)
...
mse.bump.v2=c(
mse.ash.haar.bump.v2,
mse.ash.haar.j.bump.v2,
mse.ash.s8.bump.v2,
mse.ash.s8.j.bump.v2
)
...
mse.bump.v3=c(
mse.ash.haar.bump.v3,
mse.ash.haar.j.bump.v3,
mse.ash.s8.bump.v3,
mse.ash.s8.j.bump.v3
)
...
mse.bump.v4=c(
mse.ash.haar.bump.v4,
mse.ash.haar.j.bump.v4,
mse.ash.s8.bump.v4,
mse.ash.s8.j.bump.v4
)
