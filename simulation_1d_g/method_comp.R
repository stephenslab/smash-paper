...
for(i in 1:100){
  ...
  mu.est.ash.haar.sp.1.v2[i,]=bayesmooth(sim.m.sp.1.v2[i,],sigma.sp.1.v2.est,basis="haar",gridmult=0)
  ...
  mu.est.ash.haar.sp.1.v3[i,]=bayesmooth(sim.m.sp.1.v3[i,],sigma.sp.1.v3.est,basis="haar",gridmult=0)
  ...
  mu.est.ash.haar.sp.1.v4[i,]=bayesmooth(sim.m.sp.1.v4[i,],sigma.sp.1.v4.est,basis="haar",gridmult=0)
  ...
  mu.est.ash.haar.sp.1.v5[i,]=bayesmooth(sim.m.sp.1.v5[i,],sigma.sp.1.v5.est,basis="haar",gridmult=0)
  ...
  mu.est.ashef.haar.sp.1.v2[i,]=bayesmooth(sim.m.sp.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.1.v2[i,]=bayesmooth(sim.m.sp.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.1.v3[i,]=bayesmooth(sim.m.sp.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.1.v3[i,]=bayesmooth(sim.m.sp.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.1.v4[i,]=bayesmooth(sim.m.sp.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.1.v4[i,]=bayesmooth(sim.m.sp.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.1.v5[i,]=bayesmooth(sim.m.sp.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.1.v5[i,]=bayesmooth(sim.m.sp.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.3.v1[i,]=bayesmooth(sim.m.sp.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.3.v1[i,]=bayesmooth(sim.m.sp.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.3.v2[i,]=bayesmooth(sim.m.sp.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.3.v2[i,]=bayesmooth(sim.m.sp.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.3.v3[i,]=bayesmooth(sim.m.sp.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.3.v3[i,]=bayesmooth(sim.m.sp.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.3.v4[i,]=bayesmooth(sim.m.sp.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.3.v4[i,]=bayesmooth(sim.m.sp.3.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.sp.3.v5[i,]=bayesmooth(sim.m.sp.3.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.sp.3.v5[i,]=bayesmooth(sim.m.sp.3.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.1.v1[i,]=bayesmooth(sim.m.bump.1.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.1.v1[i,]=bayesmooth(sim.m.bump.1.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.1.v2[i,]=bayesmooth(sim.m.bump.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.1.v2[i,]=bayesmooth(sim.m.bump.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.1.v3[i,]=bayesmooth(sim.m.bump.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.1.v3[i,]=bayesmooth(sim.m.bump.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.1.v4[i,]=bayesmooth(sim.m.bump.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.1.v4[i,]=bayesmooth(sim.m.bump.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.1.v5[i,]=bayesmooth(sim.m.bump.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.1.v5[i,]=bayesmooth(sim.m.bump.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.3.v1[i,]=bayesmooth(sim.m.bump.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.3.v1[i,]=bayesmooth(sim.m.bump.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.3.v2[i,]=bayesmooth(sim.m.bump.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.3.v2[i,]=bayesmooth(sim.m.bump.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.3.v3[i,]=bayesmooth(sim.m.bump.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.3.v3[i,]=bayesmooth(sim.m.bump.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.3.v4[i,]=bayesmooth(sim.m.bump.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.3.v4[i,]=bayesmooth(sim.m.bump.3.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.bump.3.v5[i,]=bayesmooth(sim.m.bump.3.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.bump.3.v5[i,]=bayesmooth(sim.m.bump.3.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.1.v1[i,]=bayesmooth(sim.m.blk.1.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.1.v1[i,]=bayesmooth(sim.m.blk.1.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.1.v2[i,]=bayesmooth(sim.m.blk.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.1.v2[i,]=bayesmooth(sim.m.blk.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.1.v3[i,]=bayesmooth(sim.m.blk.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.1.v3[i,]=bayesmooth(sim.m.blk.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.1.v4[i,]=bayesmooth(sim.m.blk.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.1.v4[i,]=bayesmooth(sim.m.blk.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.1.v5[i,]=bayesmooth(sim.m.blk.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.1.v5[i,]=bayesmooth(sim.m.blk.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.3.v1[i,]=bayesmooth(sim.m.blk.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.3.v1[i,]=bayesmooth(sim.m.blk.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.3.v2[i,]=bayesmooth(sim.m.blk.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.3.v2[i,]=bayesmooth(sim.m.blk.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.3.v3[i,]=bayesmooth(sim.m.blk.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.3.v3[i,]=bayesmooth(sim.m.blk.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.3.v4[i,]=bayesmooth(sim.m.blk.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.3.v4[i,]=bayesmooth(sim.m.blk.3.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blk.3.v5[i,]=bayesmooth(sim.m.blk.3.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blk.3.v5[i,]=bayesmooth(sim.m.blk.3.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.1.v1[i,]=bayesmooth(sim.m.ang.1.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.1.v1[i,]=bayesmooth(sim.m.ang.1.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.1.v2[i,]=bayesmooth(sim.m.ang.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.1.v2[i,]=bayesmooth(sim.m.ang.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.1.v3[i,]=bayesmooth(sim.m.ang.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.1.v3[i,]=bayesmooth(sim.m.ang.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.1.v4[i,]=bayesmooth(sim.m.ang.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.1.v4[i,]=bayesmooth(sim.m.ang.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.1.v5[i,]=bayesmooth(sim.m.ang.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.1.v5[i,]=bayesmooth(sim.m.ang.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.3.v1[i,]=bayesmooth(sim.m.ang.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.3.v1[i,]=bayesmooth(sim.m.ang.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.3.v2[i,]=bayesmooth(sim.m.ang.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.3.v2[i,]=bayesmooth(sim.m.ang.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.3.v3[i,]=bayesmooth(sim.m.ang.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.3.v3[i,]=bayesmooth(sim.m.ang.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.3.v4[i,]=bayesmooth(sim.m.ang.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.3.v4[i,]=bayesmooth(sim.m.ang.3.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.ang.3.v5[i,]=bayesmooth(sim.m.ang.3.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.ang.3.v5[i,]=bayesmooth(sim.m.ang.3.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.1.v1[i,]=bayesmooth(sim.m.dop.1.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.1.v1[i,]=bayesmooth(sim.m.dop.1.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.1.v2[i,]=bayesmooth(sim.m.dop.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.1.v2[i,]=bayesmooth(sim.m.dop.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.1.v3[i,]=bayesmooth(sim.m.dop.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.1.v3[i,]=bayesmooth(sim.m.dop.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.1.v4[i,]=bayesmooth(sim.m.dop.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.1.v4[i,]=bayesmooth(sim.m.dop.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.1.v5[i,]=bayesmooth(sim.m.dop.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.1.v5[i,]=bayesmooth(sim.m.dop.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.3.v1[i,]=bayesmooth(sim.m.dop.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.3.v1[i,]=bayesmooth(sim.m.dop.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.3.v2[i,]=bayesmooth(sim.m.dop.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.3.v2[i,]=bayesmooth(sim.m.dop.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.3.v3[i,]=bayesmooth(sim.m.dop.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.3.v3[i,]=bayesmooth(sim.m.dop.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.3.v4[i,]=bayesmooth(sim.m.dop.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.3.v4[i,]=bayesmooth(sim.m.dop.3.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.dop.3.v5[i,]=bayesmooth(sim.m.dop.3.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.dop.3.v5[i,]=bayesmooth(sim.m.dop.3.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.1.v1[i,]=bayesmooth(sim.m.blip.1.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.1.v1[i,]=bayesmooth(sim.m.blip.1.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.1.v2[i,]=bayesmooth(sim.m.blip.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.1.v2[i,]=bayesmooth(sim.m.blip.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.1.v3[i,]=bayesmooth(sim.m.blip.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.1.v3[i,]=bayesmooth(sim.m.blip.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.1.v4[i,]=bayesmooth(sim.m.blip.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.1.v4[i,]=bayesmooth(sim.m.blip.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.1.v5[i,]=bayesmooth(sim.m.blip.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.1.v5[i,]=bayesmooth(sim.m.blip.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.3.v1[i,]=bayesmooth(sim.m.blip.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.3.v1[i,]=bayesmooth(sim.m.blip.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.3.v2[i,]=bayesmooth(sim.m.blip.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.3.v2[i,]=bayesmooth(sim.m.blip.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.3.v3[i,]=bayesmooth(sim.m.blip.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.3.v3[i,]=bayesmooth(sim.m.blip.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.3.v4[i,]=bayesmooth(sim.m.blip.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.3.v4[i,]=bayesmooth(sim.m.blip.3.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.blip.3.v5[i,]=bayesmooth(sim.m.blip.3.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.blip.3.v5[i,]=bayesmooth(sim.m.blip.3.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.1.v1[i,]=bayesmooth(sim.m.cor.1.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.1.v1[i,]=bayesmooth(sim.m.cor.1.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.1.v2[i,]=bayesmooth(sim.m.cor.1.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.1.v2[i,]=bayesmooth(sim.m.cor.1.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.1.v3[i,]=bayesmooth(sim.m.cor.1.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.1.v3[i,]=bayesmooth(sim.m.cor.1.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.1.v4[i,]=bayesmooth(sim.m.cor.1.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.1.v4[i,]=bayesmooth(sim.m.cor.1.v4[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.1.v5[i,]=bayesmooth(sim.m.cor.1.v5[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.1.v5[i,]=bayesmooth(sim.m.cor.1.v5[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.3.v1[i,]=bayesmooth(sim.m.cor.3.v1[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.3.v1[i,]=bayesmooth(sim.m.cor.3.v1[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.3.v2[i,]=bayesmooth(sim.m.cor.3.v2[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.3.v2[i,]=bayesmooth(sim.m.cor.3.v2[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.3.v3[i,]=bayesmooth(sim.m.cor.3.v3[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.3.v3[i,]=bayesmooth(sim.m.cor.3.v3[i,],basis="symm8",gridmult=4)
  mu.est.ashef.haar.cor.3.v4[i,]=bayesmooth(sim.m.cor.3.v4[i,],basis="haar",gridmult=4)
  mu.est.ashef.s8.cor.3.v4[i,]=bayesmooth(sim.m.cor.3.v4[i,],basis="symm8",gridmult=4)
