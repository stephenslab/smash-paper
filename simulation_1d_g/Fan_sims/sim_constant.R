...
mu.est.inter=approx(x,mu.est,xgrid,'constant')$y
var.est.inter=approx(x,var.est,xgrid,'constant')$y
...
boxplot(var.mad,var.mad.alt,var.mad.alt1,var.mad.ev)
boxplot(var.mad.equal,var.mad.equal.alt,var.mad.equal.alt1,var.mad.equal.ev)
